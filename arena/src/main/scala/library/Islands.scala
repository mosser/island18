...
object Islands extends DiSLand {
  ...
  val s15 = 0xFB9DDB405E0071F8L
  lazy val week15: IslandMap = {
    createIsland shapedAs radial(factor = 1.11) withSize 1600 having 2000.faces builtWith Seq(
      plateau(40), flowing(rivers = 20, distance = 0.9), withMoisture(soils.normal, distance = 300),
      AssignPitch, usingBiomes(WhittakerDiagrams.caribbean))  usingSeed s15
  }

  val s16 = 0x6BC1958DDC3B44EEL
  lazy val week16: IslandMap = {
    createIsland shapedAs donut(60.percent, 45.percent) withSize 1600 having 2000.faces builtWith Seq(
      plateau(40), flowing(rivers = 20, distance = 0.9), withMoisture(soils.wet, distance = 300),
      AssignPitch, usingBiomes(WhittakerDiagrams.caribbean))  usingSeed s16
  }


  val s17 = 0x46604282EEFD7304L
  lazy val week17: IslandMap = {
    createIsland shapedAs radial(factor = 0.4) withSize 1600 having 2000.faces builtWith Seq(
      plateau(20), flowing(rivers = 15, distance = 0.9), withMoisture(soils.wet, distance = 300),
      AssignPitch, usingBiomes(WhittakerDiagrams.caribbean))   usingSeed s17
  }

  val s18 = 0xA27478436D119BD4L
  lazy val week18: IslandMap = {
    createIsland shapedAs radial(factor = 0.88) withSize 1600 having 2000.faces builtWith Seq(
      plateau(10), flowing(rivers = 40, distance = 0.9), withMoisture(soils.dry, distance = 100),
      AssignPitch, usingBiomes(WhittakerDiagrams.caribbean)) usingSeed s18
  }

  val s19 = 0x9B4937D7A7783C0EL
  lazy val week19: IslandMap = {
    createIsland shapedAs radial(factor = 0.01) withSize 1600 having 1500.faces builtWith Seq(
      ...
      AssignPitch, usingBiomes(WhittakerDiagrams.caribbean)) usingSeed s19
  }

  val s20 = 0xF72CAB3A55178C4CL
  lazy val week20: IslandMap = {
    createIsland shapedAs radial(factor = 1.59) withSize 1600 having 1500.faces builtWith Seq(
      ...
      AssignPitch, usingBiomes(WhittakerDiagrams.caribbean)) usingSeed s20
  }
